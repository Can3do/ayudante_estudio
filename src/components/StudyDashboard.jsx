...
export const StudyDashboard = ({
	activeTool,
	onToolSelect,
	onRegenerate, // Nueva prop para la función de regenerar
	onReset,
	isLoadingContent,
	isRegenerating, // Nueva prop para el estado de carga de regeneración
	generatedContent, // Ahora es un array
	error,
}) => {
	// Función para renderizar el contenido principal de forma condicional
			...
			return (
				<>
					{generatedContent.map((contentBlock, index) => (
						<div
							key={index}
							className="mb-8 p-6 bg-white rounded-lg shadow-md border border-slate-200"
						>
							<ContentDisplay
		...
		<div className="flex h-screen bg-slate-50">
			...
			<main className="flex-1 p-8 overflow-y-auto">
				<div className="max-w-4xl mx-auto">
					...
					{/* Renderiza el contenido principal usando la nueva función */}
					{renderMainContent()}
				</div>
			</main>
		</div>
